...
#add new projects to projectInformation list
$existingProjects = @()
$projectInformationListItems | % {
    $item = New-Object PSObject
    $item | Add-Member -type NoteProperty -Name 'ProjektCode' -Value $_.FieldValues.Title
...
$projectsToAdd | % {
    ...
    Add-PnPListItem -List $projectInformationList -Values $values -ContentType Element
}
